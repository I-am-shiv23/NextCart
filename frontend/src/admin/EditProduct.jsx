...
const EditProduct = () => {
      ...
      <main className="main-content">
        <section className="grid min-h-96 place-items-center bg-white p-8 text-center shadow-sm">
          <div>
            ...
            <p className="mt-2 text-gray-600">Only admin users can edit products.</p>
  ...
  return (
    <main className="main-content">
      <header className="bg-white p-5 shadow-sm">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">Update product details, image and stock.</p>
          </div>
      ...
      {loading ? (
        <section className="mt-4 grid min-h-96 place-items-center bg-white p-8 shadow-sm text-gray-600">
          Loading product...
        </section>
      ) : (
        <section className="mt-4 grid gap-4 lg:grid-cols-[1fr_340px]">
          <form className="grid gap-4 bg-white p-5 shadow-sm" onSubmit={handleSubmit}>
            ...
            <label className="grid gap-2 text-sm font-semibold text-gray-700">
              ...
              />
              <span className="text-xs font-normal text-gray-500">Leave empty to keep current image</span>
            </label>
